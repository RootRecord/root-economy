...
public final class RankLoanLimitService {
    ...
    private RootMcPermsService perms;
    ...
    public void bindPerms(RootMcPermsService perms) {
        this.perms = perms;
    }

    public boolean enabled() {
        return enabled && !tiers.isEmpty() && perms != null;
    }
    ...
    public double limitFor(UUID playerId) {
        ...
        int highest = perms.highestTrackIndex(playerId, track);
        if (highest < 0) {
            return defaultMaxLoan;
        }
